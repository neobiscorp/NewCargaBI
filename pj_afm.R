...
if(length(SFduplicados2[["Acceso"]])>0){
  ...
  SFduplicadosbuenos2<-subset(SFduplicadosbuenos,select = c("Acceso","Estado acceso","Producto","Tipo de producto","Centro de facturación","Importe de las opciones facturadas (CLP)",
  ...
  SFduplicados2<-subset(SFduplicados2,select = c("Acceso","Estado acceso","Producto","Tipo de producto","Centro de facturación","Importe de las opciones facturadas (CLP)",
                                                            "Importe descuentos sobre plano tarifario (CLP)","Importe de las opciones descontadas (CLP)","Acceso fix"))
  SF_fueradecontratoSC<-subset(SF_fueradecontratoSC,select = c("Acceso","Estado acceso","Producto","Tipo de producto","Centro de facturación","Importe de las opciones facturadas (CLP)",
                                                 "Importe descuentos sobre plano tarifario (CLP)","Importe de las opciones descontadas (CLP)","Acceso fix"))
  if(length(SFduplicados2[["Acceso"]])>0){
